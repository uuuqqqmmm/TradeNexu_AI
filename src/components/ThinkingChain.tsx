...
export const ThinkingChain: React.FC<ThinkingChainProps> = ({ content }) => {
  ...
  return (
    <div className="mb-4 rounded-lg border border-nexus-700/50 bg-nexus-800/30 overflow-hidden">
      <button onClick={() => setIsOpen(!isOpen)} className="w-full flex items-center gap-2 px-4 py-2 text-xs font-medium text-gray-400 hover:text-nexus-accent hover:bg-nexus-800/50 transition-colors">
